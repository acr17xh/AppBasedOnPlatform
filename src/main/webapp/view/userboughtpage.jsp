			...
			<div class="row">
				...
				<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
					...
					<div class="widget dashboard-container my-adslist">
						<h3 class="widget-header">Commodities bought</h3>
						<table class="table table-responsive product-dashboard-table">
							<thead>
								<tr>
									...
									<th class="text-center">View or receive</th>
								</tr>
							</thead>
							<tbody>
								...
								<c:forEach items="${transactionlist}" var="bought">
									<tr>
										...
										<td class="product-details">
											...
											<span><strong>Date: </strong> <time>${bought.transactiondate}</time>
											...
											<div class="">
												<ul class="list-inline justify-content-center">
													...
													<li class="list-inline-item"><a class="edit"
														href="${contextPath}/user/reception?transactionid=${bought.transactionid}">
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination">
								<li class="page-item"><a class="page-link"
									href="${contextPath}/user/commoditiesbought?pageinfo=1"
									aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										<span class="sr-only">First</span>
								</a></li>
								<li class="page-item"><a class="page-link"
									href="${contextPath}/user/commoditiesbought?pageinfo=${pageinfo.prePage}">Prev</a></li>
								<li class="page-item"><a class="page-link"
									href="${contextPath}/user/commoditiesbought?pageinfo=${pageinfo.nextPage}">Next</a></li>
								<li class="page-item"><a class="page-link"
									href="${contextPath}/user/commoditiesbought?pageinfo=${pageinfo.getPages()}"
