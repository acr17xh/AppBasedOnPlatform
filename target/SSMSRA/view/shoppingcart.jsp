			...
			<div class="row">
				<div class="col-md-8 offset-md-0 col-lg-8 offset-lg-0">
					<div class="widget dashboard-container my-adslist"
						id="myshoppingcart">
						<h3 class="widget-header">My shopping cart</h3>
				...
				<div class="col-md-4 offset-md-0 col-lg-4 offset-lg-0">
					<form action="${contextPath}/transaction/transactionpage"
						class="row">
						<div class="widget disclaimer">
							<h3 class="tab-title">Choose your address and Check out</h3>
							<h3 class="title">Address:</h3>
							<div class="input-group input-group-md">
								<c:if test="${addresseslist.size()==0}">
									<h3 class="title">
										<a href="${contextPath}/user/useraddress/newaddresspage">Create
											your new address</a>
									</h3>
								</c:if>
								<c:if test="${addresseslist.size()!=0}">
									<select required="required" name="shoppingcartaddress">
										<c:forEach items="${addresseslist}" var="address">
											<option>${address.addressdescription}</option>
										</c:forEach>
									</select>
								</c:if>
							</div>
							...
							<button type="submit"
								class="btn btn-default btn-success btn-block">Check out</button>
						</div>
					</form>
				</div>
			</div>
