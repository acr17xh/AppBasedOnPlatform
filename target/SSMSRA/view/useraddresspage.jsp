						...
						<form>
							<div class="form-row">
								...
								<div class="form-group col-md-3">
									<input type="text" class="form-control" id="inputCategory4"
										placeholder="Category">
								</div>
								<div class="form-group col-md-3">
									<input type="text" class="form-control" id="inputLocation4"
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 offset-md-0 col-lg-8 offset-lg-0">
					<div class="widget dashboard-container my-adslist" id="myaddresses">
						<h3 class="widget-header">My addresses</h3>
						<table class="table table-responsive product-dashboard-table">
							<thead>
								<tr>
									<!-- <th>Address id</th> -->

									<th class="text-center">Your address</th>
								...
								<c:forEach items="${addresseslist}" var="address">
									<tr>
										<!-- <td class="product-category">
											<h3 class="title">${address.addressid}</h3>
										</td> -->

										<td class="product-details"><span class="categories">${address.addressdescription}</span></td>
										<td class="action" data-title="Action">
											<div class="">
												<ul class="list-inline justify-content-center">
													<li class="list-inline-item"><a class="delete"
														href="${contextPath}/user/useraddress/remove?addressid=${address.addressid}#myaddresses">
				...
				<div class="col-md-4 offset-md-0 col-lg-4 offset-lg-0">
					<div class="widget disclaimer">
						<h3 class="tab-title">Add new address</h3>
						<!-- Submit button -->
						<form action="${contextPath}/user/useraddress/newaddresspage"
							class="row">
							<button type="submit"
								class="btn btn-default btn-success btn-block">New
								address</button>
						</form>
					</div>
				</div>
