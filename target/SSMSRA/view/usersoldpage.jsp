			...
			<div class="row">
				...
				<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
					...
					<div class="widget dashboard-container my-adslist">
						<h3 class="widget-header">Commodities sold</h3>
						<table class="table table-responsive product-dashboard-table">
							<thead>
								<tr>
									...
									<th class="text-center">View or dispatch</th>
								</tr>
							</thead>
							<tbody>

								<c:forEach items="${transactionlist}" var="bought">
									<tr>
										<td class="product-thumb"><img width="80px" height="auto"
											src="${contextPath}/user/commodityimage/${bought.commodityid}"
											alt="No image"></td>
										<td class="product-details">
											<h3 class="title">${bought.transactionname}</h3> <span
											class="add-id"><strong>Id: </strong>${bought.transactionid}</span>
											<span class="add-id"><strong>Date: </strong> <time>${bought.transactiondate}</time>
										</span> <span class="location"><strong>Description: </strong>${bought.transactiondescription}</span>

										</td>
										<td class="product-category"><span class="status active">${bought.transactionstatus}</span></td>
										<td class="action" data-title="Action">
											<div class="">
												<ul class="list-inline justify-content-center">
													<li class="list-inline-item"><a data-toggle="tooltip"
														data-placement="top" title="View" class="view"
														href="${contextPath}/buyer/commodity?commodityid=${bought.commodityid}">
															<i class="fa fa-eye"></i>
													</a></li>
													<!-- 发货按钮 -->
													<li class="list-inline-item"><a class="edit"
														href="${contextPath}/user/dispatch?transactionid=${bought.transactionid}">
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination">
								<li class="page-item"><a class="page-link"
									href="${contextPath}/user/commoditiessold?pageinfo=1"
									aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										<span class="sr-only">First</span>
								</a></li>
								<li class="page-item"><a class="page-link"
									href="${contextPath}/user/commoditiessold?pageinfo=${pageinfo.prePage}">Prev</a></li>
								<li class="page-item"><a class="page-link"
									href="${contextPath}/user/commoditiessold?pageinfo=${pageinfo.nextPage}">Next</a></li>
								<li class="page-item"><a class="page-link"
									href="${contextPath}/user/commoditiessold?pageinfo=${pageinfo.getPages()}"
